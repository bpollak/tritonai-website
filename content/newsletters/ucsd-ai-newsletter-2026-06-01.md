...
-   **[AI Companion side panel now contextual within Zoom Workplace](https://releasebot.io/updates/zoom)**: The AI Companion icon is being removed from the desktop app header. Instead, each product (Mail, Calendar, Chat, Canvas, Phone) will have its own AI Companion entry point for more relevant, in-context assistance. Rolling out to most customers by the end of May 2026.

### Microsoft Copilot with Data Protection

-   **[GPT-5.5 Instant now rolling out in Copilot Chat](https://techcommunity.microsoft.com/blog/microsoft365copilotblog/available-today-gpt-5-5-instant-in-microsoft-365-copilot/4517084)**: OpenAI’s GPT-5.5 Instant model is now available in Copilot Chat, delivering faster response times and improved contextual understanding for enterprise workflows. Rolling out through May 2026.
