...
videoSrc: https://tritongpt-deck.vercel.app/media/media11.mov
videoPoster: https://tritongpt-deck.vercel.app/media/image53.png
videoLabel: Instructional AI demo
videoDescription: Silent screen recording showing the Socratic tutor guiding students through course material and the faculty assistant generating study resources.
stats:
  - { value: "81%", label: "Student satisfaction", sub: "Helped understand concepts" }
  - { value: "86%", label: "Ease of use", sub: "Found it easy to use" }
  - { value: "67%", label: "Want more", sub: "Want it in more courses" }
toolHighlights: ["Socratic Tutor", "Faculty Assistant", "Google Drive Integration"]

relatedSlides: [Instructional AI]
