...
The workflow checks common structural and metadata problems, proposes selected fixes, and produces an evidence package for a human remediator. It is designed to accelerate expert work, not to certify conformance automatically.

## Current status

Pilot. A final document still requires manual accessibility review with the appropriate tools and standards.
