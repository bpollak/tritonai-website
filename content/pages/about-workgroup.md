...
<div class="col-md-5"><aside class="hub-quote-card"><span class="glyphicon glyphicon-transfer" aria-hidden="true"></span><h3>Governance works across layers</h3><p>The Workgroup coordinates and advises. Service owners and the appropriate privacy, security, accessibility, policy, records, and risk partners remain responsible for their decisions.</p></aside></div>
</div>
</section>
...
<div class="hub-heading"><p class="home-kicker">Representation</p><h2 id="representation-heading">Perspectives from across UC San Diego</h2><p>The Workgroup is designed for broad representation across academic, administrative, research, health, student, communications, library, engineering, finance, compliance, equity, and technology functions.</p></div>
<div class="row agent-card-grid">
<div class="col-sm-6 col-md-3"><div class="panel panel-default agent-card"><div class="panel-body"><h3>Academic mission</h3><p>Teaching, learning, faculty, research, and library perspectives.</p></div></div></div>
<div class="col-sm-6 col-md-3"><div class="panel panel-default agent-card"><div class="panel-body"><h3>Campus services</h3><p>Student, finance, communications, advancement, and administrative operations.</p></div></div></div>
<div class="col-sm-6 col-md-3"><div class="panel panel-default agent-card"><div class="panel-body"><h3>Trust partners</h3><p>Privacy, security, ethics, compliance, accessibility, equity, records, and policy.</p></div></div></div>
<div class="col-sm-6 col-md-3"><div class="panel panel-default agent-card"><div class="panel-body"><h3>Technology delivery</h3><p>Architecture, infrastructure, applications, data, support, and service management.</p></div></div></div>
</div>
</section>
