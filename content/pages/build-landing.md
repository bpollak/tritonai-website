...
<aside class="build-harness-access" aria-labelledby="harness-access-heading"><div><p class="home-kicker">Interactive agent workspace</p><h3 id="harness-access-heading">Request access, then choose a client</h3><p>The access page covers eligibility, funding, API keys, and client setup.</p></div><a class="btn btn-primary btn-lg" href="/developer-apis/start.html">Get API access</a></aside>
