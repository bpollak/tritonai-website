...
<div class="col-sm-6 col-lg-3"><article class="panel panel-default hub-action-card"><span class="glyphicon glyphicon-console" aria-hidden="true"></span><h3>Build a service</h3><p>Use governed APIs, reusable skills, and an accountable hosting path.</p><a href="/developer-apis/index.html">Build with TritonAI <span aria-hidden="true">→</span></a></article></div>
