---
title: "Example: Prompting basics for campus work"
slug: example-prompting-basics
summary: Learn the START prompting pattern and practice it on everyday campus tasks before applying it in TritonGPT.
series: Using the tools
status: Published
owner: TritonAI training program (example entry)
lastReviewed: 2026-08-02
audiences: [faculty, staff]
source: Placeholder for the first recorded training video
dataClassification: Public description
canonicalUrl: /training-resources/videos/example-prompting-basics.html
relatedSlides: []
...
quiz:
  - question: "What is the main focus of this video?"
    options:
      ...
      - "Understanding the START prompting pattern for everyday campus tasks"
      - "Configuring your campus email account"
    answer: 1
    explanation: "This video centers on the START prompting pattern for everyday campus tasks."
...
discussionPoints:
  - "Where does START prompting already show up in your team's work, and where could it help next?"
...
- Draft entry demonstrating the incremental-publishing workflow
- Stays out of the built site until status changes to Published

## Transcript

Draft placeholder. The recorded transcript lands here when the video is produced.
