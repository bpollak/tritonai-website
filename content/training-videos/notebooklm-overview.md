...
slug: notebooklm-overview
summary: Practical campus use cases for NotebookLM, from source-grounded research to study guides.
...
canonicalUrl: /training-resources/videos/notebooklm-overview.html
relatedSlides: []
...
quiz:
  - question: "What is the main focus of this video?"
    options:
      ...
      - "Understanding campus use cases for NotebookLM, from source-grounded research to study guides"
      - "Configuring your campus email account"
    answer: 1
    explanation: "This video centers on campus use cases for NotebookLM, from source-grounded research to study guides."
...
discussionPoints:
  - "Where does NotebookLM already show up in your team's work, and where could it help next?"
