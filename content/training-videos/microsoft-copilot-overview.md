...
slug: microsoft-copilot-overview
summary: Practical campus use cases for Microsoft Copilot across the tools you already use.
...
canonicalUrl: /training-resources/videos/microsoft-copilot-overview.html
relatedSlides: []
...
quiz:
  - question: "What is the main focus of this video?"
    options:
      ...
      - "Understanding campus use cases for Microsoft Copilot"
      - "Configuring your campus email account"
    answer: 1
    explanation: "This video centers on campus use cases for Microsoft Copilot."
...
discussionPoints:
  - "Where does Copilot already show up in your team's work, and where could it help next?"
