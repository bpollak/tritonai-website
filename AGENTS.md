...
The stored tree makes the review meaningful — the diff shows the node and
attribute that moved, not a hash. An agent may not decide this on its own; a
golden change needs the content owner's agreement in the pull request.
